    ...
    tryCatch(
        {
            ...
            if (!file.exists(sample_sheet_path)) {
                ...
                if (!found_sheet) {
                    ...
                    if (length(csv_files) > 0) {
                        ...
                        stop(
                            "No sample sheet found. Expected: ", sample_sheet_name,
            ...
            if (length(missing_cols) > 0) {
                ...
                for (col in missing_cols) {
                    ...
                    if (!found) {
                        stop(
                            "Required column '", col, "' not found in sample sheet.\nAvailable columns: ",
            ...
            if (any(missing_files)) {
                ...
                for (i in which(missing_files)) {
                    ...
                    if (!found_match) {
                        message(
                            "  [WARNING]  No match found for sample: ", sample_sheet$Sample_Name[i],
            ...
            if (any(final_missing_files)) {
                ...
                stop(
                    "Missing IDAT files for samples: ", paste(head(missing_samples, 10), collapse = ", "),
            ...
            if (length(failed_samples) > 0) {
                ...
                warning(
                    "Failed samples:", paste(head(failed_samples, 5), collapse = ", "),
